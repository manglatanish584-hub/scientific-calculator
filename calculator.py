...
# # Number buttons
# tk.Button(window, text="7", width=5).grid(row=1, column=0)
# tk.Button(window, text="8", width=5).grid(row=1, column=1)
# tk.Button(window, text="9", width=5).grid(row=1, column=2)
# tk.Button(window, text="/", width=5).grid(row=1, column=3)

# tk.Button(window, text="4", width=5).grid(row=2, column=0)
# tk.Button(window, text="5", width=5).grid(row=2, column=1)
# tk.Button(window, text="6", width=5).grid(row=2, column=2)
# tk.Button(window, text="*", width=5).grid(row=2, column=3)

# tk.Button(window, text="1", width=5).grid(row=3, column=0)
# tk.Button(window, text="2", width=5).grid(row=3, column=1)
# tk.Button(window, text="3", width=5).grid(row=3, column=2)
# tk.Button(window, text="-", width=5).grid(row=3, column=3)

# tk.Button(window, text="0", width=5).grid(row=4, column=0)
# tk.Button(window, text=".", width=5).grid(row=4, column=1)
# tk.Button(window, text="=", width=5).grid(row=4, column=2)
# tk.Button(window, text="+", width=5).grid(row=4, column=3)
...
# operator = input("Enter operator (+, -, *, /,sin,cos,tan,sqrt,ln,log,x^2,10^x,): ")
# if operator in ["sin","cos","tan","sqrt","ln","log","x^2","10^x"]:
